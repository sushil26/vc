...
signaling_socket.on('newTextMsg', function (data) {
    ...
    if (data.queryId == queryLink) {
        ...
        document.getElementById('message-container').innerHTML += '<div class="direct-chat-info clearfix"><span class="direct-chat-name pull-left">'
            + data.userName + '</span></div><i class="direct-chat-img"> <i class="fa fa-user-circle fa-2x" style="margin-left: 3px; margin-top: 4px;"></i></i><div class="content direct-chat-text new_windowAutoLink">' + data.message + '</div><div class="direct-chat-info clearfix"><span class="direct-chat-timestamp pull-right">' + time + '</span></div>'
        autoLinkNeed();
        scrollDown();
...
function appendFile(URI, type, name, queryId) {
    ...
    if (queryId == queryLink) {
        if (type === 'image') {
            console.log("image");
            document.getElementById('message-container').innerHTML += '<div class="direct-chat-info clearfix"><span class="direct-chat-name pull-left">'
                + name + '</span></div><i class="direct-chat-img"> <i class="fa fa-user-circle fa-2x" style="margin-left: 3px; margin-top: 4px;"></i><div class="content direct-chat-text new_windowAutoLink"><img src="' + URI + '" width="100px" /></div><div class="direct-chat-info clearfix"><span id=' + URI + ' class="direct-chat-timestamp pull-right"></span></div>'
            ...
            console.log("video");
            document.getElementById('message-container').innerHTML += '<div class="direct-chat-info clearfix"><span class="direct-chat-name pull-left">'
                + name + '</span></div><i class="direct-chat-img"> <i class="fa fa-user-circle fa-2x" style="margin-left: 3px; margin-top: 4px;"></i><div class="content direct-chat-text new_windowAutoLink"><video width="320" height="240" controls><source src="' + URI + '"></div><div class="direct-chat-info clearfix"><span  id=' + URI + ' class="direct-chat-timestamp pull-right"></span></div>'
            ...
            document.getElementById('message-container').innerHTML += '<div class="direct-chat-info clearfix"><span class="direct-chat-name pull-left">'
                + name + '</span></div> <i class="direct-chat-img"> <i class="fa fa-user-circle fa-2x" style="margin-left: 3px; margin-top: 4px;"></i><div class="content direct-chat-text new_windowAutoLink"><a width="320" height="240" href=' + URI + ' target="_blank" download=' + URI + '><source src="' + URI + '">Download Here</a></div><div class="direct-chat-info clearfix"><span  id=' + URI + ' class="direct-chat-timestamp pull-right"></span></div>'
