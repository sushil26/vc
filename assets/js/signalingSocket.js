...
function setup_local_media(callback, errorback) {
    ...
    navigator.getUserMedia({ "audio": USE_AUDIO, "video": USE_VIDEO },
        function (stream) { /* user accepted access to a/v */
            ...
            $('#portfolio-wrapper').append('<center><div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 portfolio-items"><div id="videosAttach"></div><div class="details"><button id="fullscreenbtn"  class="icon-resize-full" style="float:left;"></button><h4>' + userName + '</h4><span>All is well</span></div></div></center>');
