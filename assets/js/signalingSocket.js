    ...
    */
    signaling_socket.on('addPeer', function (config) {
        ...
        peer_connection.onaddstream = function (event) {
            ...
            remote_media.attr("id", peer_id + "Remote");
            $('#portfolio-wrapper').append('<center><div id="' + peer_id + 'remoteContainer" class="col-xs-12 col-sm-6 col-md-4 col-lg-3  portfolio-items" ><div id="' + peer_id + 'remoteVideoElement"></div><div class="details"> <i style="float:left;color: #555555e3; margin-top: -15px; margin-left: 10px;" id="fullscreenbtn2" class="fa fa-window-close cancel></i> <h4>' + config.userName + '</h4><i style="display:none; float:right;color: #555555e3; margin-top: -15px; margin-right: 10px;" id="closeThisConn' + peer_id + '" class="fa fa-window-close cancelColrChange" aria-hidden="true" id="closeThisConn' + peer_id + '" owner=' + peer_id + ' name=' + config.userName + '></i><span>All is well</span></div></div></center>');
...
function setup_local_media(callback, errorback) {
    ...
    navigator.getUserMedia({ "audio": USE_AUDIO, "video": USE_VIDEO },
        function (stream) { /* user accepted access to a/v */
            ...
            $('#portfolio-wrapper').append('<center><div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 portfolio-items"><div id="videosAttach"></div><div class="details"><i style="float:left;color: #555555e3; margin-top: -15px; margin-left: 10px;" id="fullscreenbtn" class="fa fa-window-close cancel></i></i><h4>' + userName + '</h4><span>All is well</span></div></div></center>');
